...
Run the project directly, via `:main-opts` (`-m cyberland.gui`):
...
If you remove `version` from `build.clj`, the uberjar will become `target/cyberland.gui-standalone.jar`.
